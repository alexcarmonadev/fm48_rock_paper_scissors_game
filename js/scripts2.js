...
/* ------------EL JUEGO------------ */
const start = (e) => {
  showUserBtn.classList.remove('rock', 'paper', 'scissors', 'lizard', 'spock');
  showHouseBtn.classList.remove('rock', 'paper', 'scissors', 'lizard', 'spock');
  ...
  winner = () => {
    ...
    if (selectedUserBtn == selectedHouseBtn) {
      ...
      (selectedUserBtn == 'rock' &&
        (selectedHouseBtn == 'spock' || selectedHouseBtn == 'paper')) ||
      (selectedUserBtn == 'paper' &&
        (selectedHouseBtn == 'scissors' || selectedHouseBtn == 'lizard')) ||
      (selectedUserBtn == 'scissors' &&
        (selectedHouseBtn == 'spock' || selectedHouseBtn == 'rock')) ||
      (selectedUserBtn == 'lizard' &&
        (selectedHouseBtn == 'scissors' || selectedHouseBtn == 'rock')) ||
      (selectedUserBtn == 'spock' &&
        (selectedHouseBtn == 'paper' || selectedHouseBtn == 'lizard'))
    ) {
      totalScore -= 1;
